      ...
      <section className={styles.whyBlock}>
        ...
        <div className={styles.whyBlockSection}>
          <div className={styles.whyBlockImage}>
            <Image src='/static/grid-images/table1.jpg' width='385px' height='350px' objectFit='cover' alt='Custom wood coffee table' />
          </div>
        ...
        <div className={styles.whyBlockSection}>
          ...
          <div className={styles.whyBlockImage}>
            <Image src='/static/grid-images/vanity1.jpg' width='385px' height='350px' objectFit='cover' alt='Custom wood vanity in the bathroom' />
          </div>
        </div>
        <div className={styles.whyBlockSection}>
          <div className={styles.whyBlockImage}>
            <Image src='/static/grid-images/bathroom1.jpg' width='385px' height='350px' objectFit='cover' alt='Custom wooden bathroom set with vanity and mirror' />
          </div>
          <div className={styles.whyBlockText}>
